...
export const effectOptions: readonly EffectOption[] = [
  ...
  {color:"orange", title:"Bloody Wings - Feng Shui Engine", img:false, desc: "Lose max HP equal to 5% of current HP every second. Gain 15% |Life Steal Rate|, 15% increased ATK, 15% increased DMG Reduction, and 100% Effect Accuracy./n Also increases normal attack DMG by 100%, and each normal attack fills the Super Combo Gauge by an additional 50."},
  ...
  {color:"orange", title:"Fate Divination:", img:false, desc:"Upon unleashing a Super Combo or Combo, the target receives DMG equal to 174% of Diviner Rose's ATK, and has a 30% chance to have 1 buff dispelled. |Fate Divination| status ends after triggering 2 times. Cannot be triggered if Diviner Rose is defeated."},
  ...
  {color:"orange", title:"Life Divination", img:false, desc: "Upon taking DMG, recover HP equal to 92% of Diviner Rose's ATK with a 30% chance to dispel 1 debuff. |Life Divination| status ends after triggering 2 times. Cannot be triggered if Diviner Rose is defeated."},
  {color:"orange", title:"Life Steal Rate", img:false},
