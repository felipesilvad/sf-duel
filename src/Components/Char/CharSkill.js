...
function CharSkillComponent({id, skill, label, img_n, effects, getEffect}) {
    ...
    return (
      <div className='my-1'>
        ...
        <div className='char-skill__bg skill-txt__bg px-2 pt-1'>
          <CharSkillTxtComponent effects={effects} txt={skill.lv1} />
          <div className='d-flex'>
            <div className='vl'></div>
            <div className=''>
              <b className='skill-label lv-color'>Lv.2</b><br />
              <CharSkillTxtComponent effects={effects} txt={skill.lv2} />
              <b className='skill-label lv-color'>Lv.3</b><br />
              <CharSkillTxtComponent effects={effects} txt={skill.lv3} />
              {skill.lv4&&(
                <>
                  <b className='skill-label lv-color'>Lv.4</b><br />
                  <CharSkillTxtComponent effects={effects} txt={skill.lv4} />
                </>
              )}
            </div>
          </div>
