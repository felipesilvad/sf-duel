      ...
      <Link to={`/char/${char.id}`}>
        ...
        <div>
          ...
          <h2 className={`ardela char-list__txt`}>
            {(char.id === '0013'||char.id === '0021'||char.id === '0031'||char.id === '0035'||char.id === '0036'||char.id === '0039'||char.id === '0041'||char.id === '0047') ? (
              ...
              (char.id === '0022'||char.id === '0032'||char.id === '0033'||char.id === '0042'||char.id === '0048') ? (
